...
class BaseCAM:
    ...
    *args, **kwargs) -> np.ndarray:
        ...
        self.outputs = outputs = self.activations_and_grads(input_tensor, *args, **kwargs)
    ...
    *args, **kwargs) -> np.ndarray:
        ...
        for transform in self.tta_transforms:
            ...
            cam = self.forward(augmented_tensor, targets, eigen_smooth, *args, **kwargs)
    ...
    def __call__(
        ...
        **kwargs
        ...
        if aug_smooth is True:
            return self.forward_augmentation_smoothing(input_tensor, targets, eigen_smooth, *args, **kwargs)

        return self.forward(input_tensor, targets, eigen_smooth, *args, **kwargs)
