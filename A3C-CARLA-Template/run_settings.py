...
SERV_RESY = 480  # Server Y resolutio
...
11) Random choice between different sets of points, defined for specific maneuvers (different turns on different junctions)
...
# Speed and distance rewards are in the rl_configuration.py/reward_function
