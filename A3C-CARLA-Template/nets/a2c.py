...
#         x = self.layer4(x)
#         speed= None
#         if speed is None and maneuver is None:
#             actor = self.actor(x)
#         elif speed is not None and maneuver is None:
...
#         elif speed is not None and maneuver is not None:
#             pass
...
#         maneuver = F.one_hot(maneuver, num_classes=3).float().to(self.device)
...
#         combined = torch.cat([cnn_features, speed_features, maneuver_features], dim=1)
